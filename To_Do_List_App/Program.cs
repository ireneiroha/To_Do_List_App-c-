    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (option != "e")
            {
                ...
                Console.WriteLine("Enter 3 to view a task from the list.");
                Console.WriteLine("Enter e to exist a task from the program.");

                option = Console.ReadLine();

                if (option == "1")
                {
                    Console.WriteLine("Please enter the name of the tak to add to the list.");
